...
from .extractors_3d import DMLP

class Vox2DCNN(BaseFeaturesExtractor):
    def __init__(self, observation_space, features_dim, dropout=0.0, first_stride=2, out_len=16):
